...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,nextjs,nestjs,netlify,nodejs,express,notion,npm,nuxtjs,py,django,react,redux,supabase,tailwind,mongodb,mysql,git,github,firebase,electron,docker,bootstrap,express,fastapi,figma,fastapi,heroku,php)](https://skillicons.dev)
